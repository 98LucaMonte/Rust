...
mod tests {  
    ...
    fn test_conto_rosso() {
        ...
        assert_eq!(conto_bancario_luca.get_stato().stato_attuale_conto(), StatoTipo::Rosso);
    ...
    fn test_conto_rosso_deposita_rosso() {
        ...
        assert_eq!(conto_bancario_luca.get_stato().stato_attuale_conto(), StatoTipo::Argento);
        assert_eq!(conto_bancario_luca.get_saldo(), 1200.0);

        conto_bancario_luca.deposita( 10000.0);
        assert_eq!(conto_bancario_luca.get_stato().stato_attuale_conto(), StatoTipo::Oro);
